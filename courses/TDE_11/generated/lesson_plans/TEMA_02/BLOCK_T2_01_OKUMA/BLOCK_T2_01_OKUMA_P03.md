# KÜLTÜR YOLCULUĞU — Okuma 3: Çözümleyebilme
...
15 saatlik okuma bloğunun bu 2 saatlik bölümünde ders kitabındaki doğrulanmış etkinlikler kullanılarak TDE2.2 çıktısına yönelik somut öğrenci kanıtı üretilir. Saat içi akış pedagojik öneridir; resmî MEB alt-saat sıralaması olarak sunulmaz.

## Öğrenme ve değerlendirme kapsamı

- **Öğrenme çıktıları:** `TDE2.2`
- **Kullanılan etkinlikler:** `T2_ACT_03_OKUMA_UYGULAMA_COZUMLEME`
...
Öğrencinin metni yapı, tür, dil-anlatım ve dönem/bağlam özellikleri bakımından çözümler ve karşılaştırır. sürecinde TDE2.2 çıktısına yönelik gözlenebilir ve gerekçeli kanıt üretmesi.
...
- **Etkinlikler:** `T2_ACT_03_OKUMA_UYGULAMA_COZUMLEME`
- **Formlar:** Yok
...
- Metin Tahlili-1 (Anlama): Okuma — Hikâye / Anı — ders kitabı s.105
...
<!-- TYMM_JSON_SHA256:8c75723b10860bdb634b1d29b6906db735c4e47b681c71b97c6ac6adf1ae520d -->
