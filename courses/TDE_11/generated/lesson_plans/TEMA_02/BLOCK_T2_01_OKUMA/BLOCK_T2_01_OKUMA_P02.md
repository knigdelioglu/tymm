# KÜLTÜR YOLCULUĞU — Okuma 2: Anlam Oluşturabilme
...
- **Kullanılan etkinlikler:** `T2_ACT_02_OKUMA_ICERIK_ANLAM`
- **Kullanılan formlar:** Yok

# Ders akışı

## 1. Ders — Hikâye ve Anıda Anlam İzleri: Kanıtları Belirleme
...
Öğrenci, “Anlam Oluşturabilme” etkinliğinde metnin konu, tema, ileti, söz varlığı ve bağlamından anlam oluşturur. Bu ders saatinin pedagojik odağı: konu, tema, ileti, söz varlığı ve bağlama ilişkin metin kanıtlarını seçme; somut kanıt: Anlama cevapları, işaretlemeler ve seçilmiş metin kanıtları.

### Derse giriş

Metin Tahlili-1 (Anlama): Okuma — Hikâye / Anı — ders kitabı s.95 üzerinden bu saatin odağı görünür kılınır: Konu, tema, ileti, söz varlığı ve bağlama ilişkin metin kanıtlarını seçme. Öğrenci önceki/başlangıç kanıtını kısa biçimde önüne alır ve bu saatin sonunda neyin değişmiş veya derinleşmiş olması gerektiğini kendi cümlesiyle belirtir.
...
4. Bu saate özgü kanıtı topla: Anlama cevapları, işaretlemeler ve seçilmiş metin kanıtları. Yalnız katılımı yeterli kanıt sayma; öğrencinin yaptığı bilişsel işlemi ürününde veya kaydında görünür kıl.

### Öğrencinin yapacakları

- Metnin konu, tema, ileti, söz varlığı ve bağlamından anlam oluşturur.
- Konu, tema, ileti, söz varlığı ve bağlama ilişkin metin kanıtlarını seçme.
- Kanıt olarak şunu üretir veya günceller: Anlama cevapları, işaretlemeler ve seçilmiş metin kanıtları.
- İlk kanıtında ikinci saatte sınayacağı, karşılaştıracağı, geliştireceği veya aktaracağı tek noktayı işaretler.

### Kaynak bağları

- **Etkinlikler:** `T2_ACT_02_OKUMA_ICERIK_ANLAM`
- **Formlar:** Yok

### Ölçme / öğrenme kanıtı

Bu ders saatinin birincil ölçme kanıtı “Anlama cevapları, işaretlemeler ve seçilmiş metin kanıtları”dir. Değerlendirme, öğrencinin “Konu, tema, ileti, söz varlığı ve bağlama ilişkin metin kanıtlarını seçme” işlemini görünür ve gerekçeli biçimde yapıp yapmadığına dayanır; kaynakta doğrulanmamış puan aralığı veya rubrik ölçütü eklenmez.

### Kapanış

Öğrenci “Anlama cevapları, işaretlemeler ve seçilmiş metin kanıtları” kanıtında ikinci derse taşıyacağı tek soruyu, varsayımı veya geliştirme noktasını işaretler.

### Materyaller

- Metin Tahlili-1 (Anlama): Okuma — Hikâye / Anı — ders kitabı s.95
- Öğrencinin bu ders saatinde oluşturduğu somut kanıt kaydı

## 2. Ders — Konu, Tema ve İleti: Kanıttan Yoruma
...
Metin Tahlili-1 (Anlama): Okuma — Hikâye / Anı — ders kitabı s.95 üzerinden bu saatin odağı görünür kılınır: Seçilen kanıtların tema, ileti ve bağlamla ilişkisini yorumlama. Öğrenci önceki/başlangıç kanıtını kısa biçimde önüne alır ve bu saatin sonunda neyin değişmiş veya derinleşmiş olması gerektiğini kendi cümlesiyle belirtir.
...
- İlk kanıtıyla bu saatin kanıtını karşılaştırır ve değişimi açıklar: Kanıt bulmaktan kanıtın ne gösterdiğini açıklamaya geçilir.
...
Öğrenci ilk kanıt ile son kanıt arasındaki farkı tek cümlede açıklar ve şu ilerlemeyi görünür kılar: Kanıt bulmaktan kanıtın ne gösterdiğini açıklamaya geçilir.
...
- **Blokta kalan:** 11 saat
- **Kapsanan çıktılar:** `TDE2.1`
- **Kullanılan etkinlikler:** `T2_ACT_02_OKUMA_ICERIK_ANLAM`
- **Sonraki adım:** Aynı okuma bloğunda kalan 11 saatte kullanılmamış veya derinleştirilecek doğrulanmış kitap etkinlikleriyle beceri kanıtını ilerlet.

---

<!-- TYMM_JSON_SHA256:5674a01fe02e832c180938dd1e7adc81d7b539a2d291a76dab3dccf381c58938 -->
