# KÜLTÜR YOLCULUĞU — Konuşma 3: Kural Uygulayabilme
...
- **Kullanılan etkinlikler:** `T2_ACT_11_KONUSMA_UYGULAMA_COZUMLEME`
...
## 1. Ders — Türk Kültürü Konuşması I: İlk Performans ve Gözlem
...
Öğrenci, “Kural Uygulayabilme” etkinliğinde planladığı konuşmayı bağlama uygun dil, beden dili, ses, zaman ve mekân kullanımıyla gerçekleştirir. Bu ders saatinin pedagojik odağı: planlanan konuşmayı bağlama uygun dil, beden dili, ses, zaman ve mekân kullanımıyla gerçekleştirme; somut kanıt: İlk canlı sözlü performans ve gözlem kaydı.

### Derse giriş

Edebiyat Atölyesi-1 (Anlatma): Konuşma — Türk Kültürünün Özelliklerini Yansıtan Bir Konuşma — ders kitabı s.134 üzerinden bu saatin odağı görünür kılınır: Planlanan konuşmayı bağlama uygun dil, beden dili, ses, zaman ve mekân kullanımıyla gerçekleştirme. Öğrenci önceki/başlangıç kanıtını kısa biçimde önüne alır ve bu saatin sonunda neyin değişmiş veya derinleşmiş olması gerektiğini kendi cümlesiyle belirtir.
...
4. Bu saate özgü kanıtı topla: İlk canlı sözlü performans ve gözlem kaydı. Yalnız katılımı yeterli kanıt sayma; öğrencinin yaptığı bilişsel işlemi ürününde veya kaydında görünür kıl.

### Öğrencinin yapacakları

- Planladığı konuşmayı bağlama uygun dil, beden dili, ses, zaman ve mekân kullanımıyla gerçekleştirir.
- Planlanan konuşmayı bağlama uygun dil, beden dili, ses, zaman ve mekân kullanımıyla gerçekleştirme.
- Kanıt olarak şunu üretir veya günceller: İlk canlı sözlü performans ve gözlem kaydı.
- İlk kanıtında ikinci saatte sınayacağı, karşılaştıracağı, geliştireceği veya aktaracağı tek noktayı işaretler.

### Kaynak bağları

- **Etkinlikler:** `T2_ACT_11_KONUSMA_UYGULAMA_COZUMLEME`
- **Formlar:** Yok

### Ölçme / öğrenme kanıtı

Bu ders saatinin birincil ölçme kanıtı “İlk canlı sözlü performans ve gözlem kaydı”dir. Değerlendirme, öğrencinin “Planlanan konuşmayı bağlama uygun dil, beden dili, ses, zaman ve mekân kullanımıyla gerçekleştirme” işlemini görünür ve gerekçeli biçimde yapıp yapmadığına dayanır; kaynakta doğrulanmamış puan aralığı veya rubrik ölçütü eklenmez.

### Kapanış

Öğrenci “İlk canlı sözlü performans ve gözlem kaydı” kanıtında ikinci derse taşıyacağı tek soruyu, varsayımı veya geliştirme noktasını işaretler.

### Materyaller

- Edebiyat Atölyesi-1 (Anlatma): Konuşma — Türk Kültürünün Özelliklerini Yansıtan Bir Konuşma — ders kitabı s.134
- Öğrencinin bu ders saatinde oluşturduğu somut kanıt kaydı

## 2. Ders — Türk Kültürü Konuşması II: Gözlemden Yeniden Performansa
...
Edebiyat Atölyesi-1 (Anlatma): Konuşma — Türk Kültürünün Özelliklerini Yansıtan Bir Konuşma — ders kitabı s.134 üzerinden bu saatin odağı görünür kılınır: Gözlem kanıtından seçilen hedefli değişikliği uygulayarak ikinci performansı gerçekleştirme. Öğrenci önceki/başlangıç kanıtını kısa biçimde önüne alır ve bu saatin sonunda neyin değişmiş veya derinleşmiş olması gerektiğini kendi cümlesiyle belirtir.
...
<!-- TYMM_JSON_SHA256:70d9e2a9d3a00e1e79f99998af22ebe1adfd53b1741c9be80b801df7a332fda3 -->
