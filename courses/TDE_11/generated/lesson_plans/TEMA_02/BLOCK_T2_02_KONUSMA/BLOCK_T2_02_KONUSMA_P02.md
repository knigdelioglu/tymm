# KÜLTÜR YOLCULUĞU — Konuşma 2: İçerik Oluşturabilme
...
10 saatlik konuşma bloğunun bu 2 saatlik bölümünde ders kitabındaki doğrulanmış etkinlikler kullanılarak TDE3.2 çıktısına yönelik somut öğrenci kanıtı üretilir. Saat içi akış pedagojik öneridir; resmî MEB alt-saat sıralaması olarak sunulmaz.

## Öğrenme ve değerlendirme kapsamı

- **Öğrenme çıktıları:** `TDE3.2`
- **Kullanılan etkinlikler:** `T2_ACT_10_KONUSMA_ICERIK_ANLAM`
...
Öğrencinin konuşma için bilgi, örnek, görsel/işitsel destek ve söz varlığını seçerek içeriği yapılandırır. sürecinde TDE3.2 çıktısına yönelik gözlenebilir ve gerekçeli kanıt üretmesi.

### Derse giriş

“İçerik Oluşturabilme” görevinin amacı ve beklenen kanıt görünür hâle getirilir; öğrenci neyi göstereceğini kendi cümlesiyle ifade eder.

### Öğretmenin yapacakları

1. “İçerik Oluşturabilme” etkinliğinin yönergesini ders kitabındaki doğrulanmış kapsamla uygula; kaynakta olmayan ölçüt veya içerik ekleme.
2. Öğrenciden konuşma için bilgi, örnek, görsel/işitsel destek ve söz varlığını seçerek içeriği yapılandırır. sırasında kararını metin, dinleme/izleme, konuşma ya da yazma ürünündeki somut göstergelerle gerekçelendirmesini iste.
3. Kanıt olarak konuşma metni/senaryo/akış taslağı ve içerik düzenleme kayıtları. topla; yalnız “katıldı/yaptı” türü genel gözlemi yeterli kabul etme.
...
- **Etkinlikler:** `T2_ACT_10_KONUSMA_ICERIK_ANLAM`
- **Formlar:** Yok

### Ölçme / öğrenme kanıtı

Bu ders saatinin ana ölçme kanıtı: Konuşma metni/senaryo/akış taslağı ve içerik düzenleme kayıtları.. Öğretmen geri bildirimi kanıtın doğruluğu, gerekçesi ve görevin gerektirdiği beceriye uygunluğu üzerinden verilir.

### Kapanış

Öğrenci “Bu derste konuşma metni/senaryo/akış taslağı ve içerik düzenleme kayıtları. ile neyi gösterebildim; bir sonraki uygulamada hangi somut değişikliği yapacağım?” sorusuna kısa kanıt notuyla cevap verir.

### Materyaller

- Edebiyat Atölyesi-1 (Anlatma): Konuşma — Türk Kültürünün Özelliklerini Yansıtan Bir Konuşma — ders kitabı s.131
...
<!-- TYMM_JSON_SHA256:84b72946dc92a8a5c67544e2108692826c664c97b2c080d795fa058be46c0a8e -->
