# KÜLTÜR YOLCULUĞU — Dinleme/Izleme 4: Süreci Değerlendirebilme
...
| Ders | `TDE_11` |
| Tema | `TEMA_02` |
| Blok | `BLOCK_T2_03_DINLEME` |
| Süre | 2 ders saati |
| Şema | `1.0.0` |

## Paket özeti

8 saatlik dinleme/izleme bloğunun bu 2 saatlik bölümünde ders kitabındaki doğrulanmış etkinlikler kullanılarak ilgili öğrenme çıktısına yönelik somut öğrenci kanıtı üretilir. Saat içi akış pedagojik öneridir; resmî MEB alt-saat sıralaması olarak sunulmaz.

## Öğrenme ve değerlendirme kapsamı

- **Öğrenme çıktıları:** `TDE1.4`
- **Kullanılan etkinlikler:** `T2_ACT_16_DINLEME_DEGERLENDIRME`
- **Kullanılan formlar:** `FORM_T2_P139_GOZLEM_FORMU_07`, `FORM_T2_P139_KONTROL_LISTESI_06`, `FORM_T2_P143_KONTROL_LISTESI_08`
...
| Form | Kullanım |
|---|---|
| `FORM_T2_P139_GOZLEM_FORMU_07` | `USED` |
| `FORM_T2_P139_KONTROL_LISTESI_06` | `USED` |
| `FORM_T2_P143_KONTROL_LISTESI_08` | `USED` |
...
## 1. Ders — Âşık Atışması Dinlemesini Değerlendirme: Gözlem Kanıtı
...
Öğrenci, “Süreci Değerlendirebilme” etkinliğinde dinleme/izleme sürecini ve metne ilişkin değerlendirmelerini ölçütlere dayalı biçimde yansıtır. Bu ders saatinin pedagojik odağı: dinleme/izleme sürecini doğrulanmış gözlem/kontrol listeleri ve kendi kanıtlarıyla değerlendirme; somut kanıt: Gözlem/kontrol listesi destekli gerekçeli değerlendirme kaydı.

### Derse giriş

Metin Tahlili-3 (Anlama): Dinleme / İzleme — Âşık Atışması — ders kitabı s.147 üzerinden bu saatin odağı görünür kılınır: Dinleme/izleme sürecini doğrulanmış gözlem/kontrol listeleri ve kendi kanıtlarıyla değerlendirme. Öğrenci önceki/başlangıç kanıtını kısa biçimde önüne alır ve bu saatin sonunda neyin değişmiş veya derinleşmiş olması gerektiğini kendi cümlesiyle belirtir.
...
4. Bu saate özgü kanıtı topla: Gözlem/kontrol listesi destekli gerekçeli değerlendirme kaydı. Yalnız katılımı yeterli kanıt sayma; öğrencinin yaptığı bilişsel işlemi ürününde veya kaydında görünür kıl.

### Öğrencinin yapacakları

- Dinleme/izleme sürecini ve metne ilişkin değerlendirmelerini ölçütlere dayalı biçimde yansıtır.
- Dinleme/izleme sürecini doğrulanmış gözlem/kontrol listeleri ve kendi kanıtlarıyla değerlendirme.
- Kanıt olarak şunu üretir veya günceller: Gözlem/kontrol listesi destekli gerekçeli değerlendirme kaydı.
- İlk kanıtında ikinci saatte sınayacağı, karşılaştıracağı, geliştireceği veya aktaracağı tek noktayı işaretler.

### Kaynak bağları

- **Etkinlikler:** `T2_ACT_16_DINLEME_DEGERLENDIRME`
- **Formlar:** Yok

### Ölçme / öğrenme kanıtı

Bu ders saatinin birincil ölçme kanıtı “Gözlem/kontrol listesi destekli gerekçeli değerlendirme kaydı”dir. Değerlendirme, öğrencinin “Dinleme/izleme sürecini doğrulanmış gözlem/kontrol listeleri ve kendi kanıtlarıyla değerlendirme” işlemini görünür ve gerekçeli biçimde yapıp yapmadığına dayanır; kaynakta doğrulanmamış puan aralığı veya rubrik ölçütü eklenmez.

### Kapanış

Öğrenci “Gözlem/kontrol listesi destekli gerekçeli değerlendirme kaydı” kanıtında ikinci derse taşıyacağı tek soruyu, varsayımı veya geliştirme noktasını işaretler.

### Materyaller

- Metin Tahlili-3 (Anlama): Dinleme / İzleme — Âşık Atışması — ders kitabı s.147
- Öğrencinin bu ders saatinde oluşturduğu somut kanıt kaydı

## 2. Ders — Kontrol Listesinden Sonraki Dinlemeye: Strateji Kararı
...
Öğrenci, “Süreci Değerlendirebilme” etkinliğinde dinleme/izleme sürecini ve metne ilişkin değerlendirmelerini ölçütlere dayalı biçimde yansıtır. Bu ders saatinin pedagojik odağı: değerlendirme sonucunu sonraki dinleme/izleme görevinde uygulanacak açık strateji kararına dönüştürme; somut kanıt: Somut dinleme/izleme transfer kararı.

### Derse giriş

Metin Tahlili-3 (Anlama): Dinleme / İzleme — Âşık Atışması — ders kitabı s.147 üzerinden bu saatin odağı görünür kılınır: Değerlendirme sonucunu sonraki dinleme/izleme görevinde uygulanacak açık strateji kararına dönüştürme. Öğrenci önceki/başlangıç kanıtını kısa biçimde önüne alır ve bu saatin sonunda neyin değişmiş veya derinleşmiş olması gerektiğini kendi cümlesiyle belirtir.
...
4. Bu saate özgü kanıtı topla: Somut dinleme/izleme transfer kararı. Yalnız katılımı yeterli kanıt sayma; öğrencinin yaptığı bilişsel işlemi ürününde veya kaydında görünür kıl.

### Öğrencinin yapacakları

- Dinleme/izleme sürecini ve metne ilişkin değerlendirmelerini ölçütlere dayalı biçimde yansıtır.
- Değerlendirme sonucunu sonraki dinleme/izleme görevinde uygulanacak açık strateji kararına dönüştürme.
- Kanıt olarak şunu üretir veya günceller: Somut dinleme/izleme transfer kararı.
- İlk kanıtıyla bu saatin kanıtını karşılaştırır ve değişimi açıklar: Değerlendirmeden gelecekte kullanılacak strateji kararına geçilir.

### Kaynak bağları

- **Etkinlikler:** `T2_ACT_16_DINLEME_DEGERLENDIRME`
- **Formlar:** `FORM_T2_P139_GOZLEM_FORMU_07`, `FORM_T2_P139_KONTROL_LISTESI_06`, `FORM_T2_P143_KONTROL_LISTESI_08`

### Ölçme / öğrenme kanıtı

Bu ders saatinin birincil ölçme kanıtı “Somut dinleme/izleme transfer kararı”dir. Değerlendirme, öğrencinin “Değerlendirme sonucunu sonraki dinleme/izleme görevinde uygulanacak açık strateji kararına dönüştürme” işlemini görünür ve gerekçeli biçimde yapıp yapmadığına dayanır; kaynakta doğrulanmamış puan aralığı veya rubrik ölçütü eklenmez.

### Kapanış

Öğrenci ilk kanıt ile son kanıt arasındaki farkı tek cümlede açıklar ve şu ilerlemeyi görünür kılar: Değerlendirmeden gelecekte kullanılacak strateji kararına geçilir.
...
<!-- TYMM_JSON_SHA256:0088d9e540a6e740ef80687e83244f638a289964c0d7b64b93a48923abbc77f9 -->
