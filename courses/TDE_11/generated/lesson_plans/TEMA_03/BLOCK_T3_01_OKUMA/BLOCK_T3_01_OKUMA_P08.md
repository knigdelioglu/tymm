# YAŞAMIN İZİNDE — Okuma 8: Süreci Değerlendirebilme
...
- **Kullanılan etkinlikler:** `T3_ACT_08_OKUMA_DEGERLENDIRME`
- **Kullanılan formlar:** `FORM_T3_P193_CIKIS_KARTI_01`
...
| Form | Kullanım |
|---|---|
| `FORM_T3_P193_CIKIS_KARTI_01` | `USED` |
...
## 1. Ders — Okuma Bloğunu Kapatma: Çıkış Kartı ve Transfer
...
Öğrenci, “Süreci Değerlendirebilme” etkinliğinde okuma sürecini ve metne ilişkin yargılarını belirlediği ölçütlerle değerlendirir. Bu ders saatinin pedagojik odağı: okuma sürecini doğrulanmış çıkış kartı kanıtıyla değerlendirip tek bir transfer kararı belirleme; somut kanıt: Doğrulanmış çıkış kartına dayalı öz değerlendirme.

### Derse giriş

Metin Tahlili-2 (Anlama): Okuma — Biyografi / Tezkire — ders kitabı s.209 üzerinden bu saatin odağı görünür kılınır: Okuma sürecini doğrulanmış çıkış kartı kanıtıyla değerlendirip tek bir transfer kararı belirleme. Öğrenci önceki/başlangıç kanıtını kısa biçimde önüne alır ve bu saatin sonunda neyin değişmiş veya derinleşmiş olması gerektiğini kendi cümlesiyle belirtir.
...
4. Bu saate özgü kanıtı topla: Doğrulanmış çıkış kartına dayalı öz değerlendirme. Yalnız katılımı yeterli kanıt sayma; öğrencinin yaptığı bilişsel işlemi ürününde veya kaydında görünür kıl.

### Öğrencinin yapacakları

- Okuma sürecini ve metne ilişkin yargılarını belirlediği ölçütlerle değerlendirir.
- Okuma sürecini doğrulanmış çıkış kartı kanıtıyla değerlendirip tek bir transfer kararı belirleme.
- Kanıt olarak şunu üretir veya günceller: Doğrulanmış çıkış kartına dayalı öz değerlendirme.
- İlk kanıtında ikinci saatte sınayacağı, karşılaştıracağı, geliştireceği veya aktaracağı tek noktayı işaretler.

### Kaynak bağları

- **Etkinlikler:** `T3_ACT_08_OKUMA_DEGERLENDIRME`
- **Formlar:** `FORM_T3_P193_CIKIS_KARTI_01`

### Ölçme / öğrenme kanıtı

Bu ders saatinin birincil ölçme kanıtı “Doğrulanmış çıkış kartına dayalı öz değerlendirme”dir. Değerlendirme, öğrencinin “Okuma sürecini doğrulanmış çıkış kartı kanıtıyla değerlendirip tek bir transfer kararı belirleme” işlemini görünür ve gerekçeli biçimde yapıp yapmadığına dayanır; kaynakta doğrulanmamış puan aralığı veya rubrik ölçütü eklenmez.

### Kapanış

Öğrenci “Doğrulanmış çıkış kartına dayalı öz değerlendirme” kanıtında ikinci derse taşıyacağı tek soruyu, varsayımı veya geliştirme noktasını işaretler.

### Materyaller

- Metin Tahlili-2 (Anlama): Okuma — Biyografi / Tezkire — ders kitabı s.209
...
<!-- TYMM_JSON_SHA256:18237a145dca80763db4c910db1f3442288bdc01dd15b52d71315af1f4a287ba -->
