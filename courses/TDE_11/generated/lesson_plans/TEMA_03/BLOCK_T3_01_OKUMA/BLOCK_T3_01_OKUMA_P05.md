# YAŞAMIN İZİNDE — Okuma 5: Okumayı Yönetebilme
...
## 1. Ders — Biyografi ve Tezkireye Hazırlık: Amaç, Strateji ve Tahmin
...
Öğrenci, “Okumayı Yönetebilme” etkinliğinde okuma amacını ve stratejisini belirler, ön bilgilerini etkinleştirir ve metne ilişkin tahmin geliştirir. Bu ders saatinin pedagojik odağı: biyografi/tezkire için amaç, strateji ve tahmin oluşturma; somut kanıt: Okuma öncesi cevaplar, tahminler ve hazırlık notları.

### Derse giriş

Metin Tahlili-2 (Anlama): Okuma — Biyografi / Tezkire — ders kitabı s.195 üzerinden bu saatin odağı görünür kılınır: Biyografi/tezkire için amaç, strateji ve tahmin oluşturma. Öğrenci önceki/başlangıç kanıtını kısa biçimde önüne alır ve bu saatin sonunda neyin değişmiş veya derinleşmiş olması gerektiğini kendi cümlesiyle belirtir.
...
- Biyografi/tezkire için amaç, strateji ve tahmin oluşturma.
...
- **Etkinlikler:** `T3_ACT_05_OKUMA_YONETIM`
- **Formlar:** Yok

### Ölçme / öğrenme kanıtı

Bu ders saatinin birincil ölçme kanıtı “Okuma öncesi cevaplar, tahminler ve hazırlık notları”dir. Değerlendirme, öğrencinin “Biyografi/tezkire için amaç, strateji ve tahmin oluşturma” işlemini görünür ve gerekçeli biçimde yapıp yapmadığına dayanır; kaynakta doğrulanmamış puan aralığı veya rubrik ölçütü eklenmez.
...
- Metin Tahlili-2 (Anlama): Okuma — Biyografi / Tezkire — ders kitabı s.195
- Öğrencinin bu ders saatinde oluşturduğu somut kanıt kaydı

## 2. Ders — İki Tür İçin Strateji Seçimini Kaynakla Savunma
...
Öğrenci, “Okumayı Yönetebilme” etkinliğinde okuma amacını ve stratejisini belirler, ön bilgilerini etkinleştirir ve metne ilişkin tahmin geliştirir. Bu ders saatinin pedagojik odağı: amaç ve strateji seçimini tür göstergeleriyle savunup gerektiğinde revize etme; somut kanıt: Gerekçelendirilmiş ve revize edilmiş hazırlık kaydı.

### Derse giriş

Metin Tahlili-2 (Anlama): Okuma — Biyografi / Tezkire — ders kitabı s.195 üzerinden bu saatin odağı görünür kılınır: Amaç ve strateji seçimini tür göstergeleriyle savunup gerektiğinde revize etme. Öğrenci önceki/başlangıç kanıtını kısa biçimde önüne alır ve bu saatin sonunda neyin değişmiş veya derinleşmiş olması gerektiğini kendi cümlesiyle belirtir.
...
- Okuma amacını ve stratejisini belirler, ön bilgilerini etkinleştirir ve metne ilişkin tahmin geliştirir.
- Amaç ve strateji seçimini tür göstergeleriyle savunup gerektiğinde revize etme.
...
Bu ders saatinin birincil ölçme kanıtı “Gerekçelendirilmiş ve revize edilmiş hazırlık kaydı”dir. Değerlendirme, öğrencinin “Amaç ve strateji seçimini tür göstergeleriyle savunup gerektiğinde revize etme” işlemini görünür ve gerekçeli biçimde yapıp yapmadığına dayanır; kaynakta doğrulanmamış puan aralığı veya rubrik ölçütü eklenmez.
...
<!-- TYMM_JSON_SHA256:073f6c0a47612d9deb80f06ad1abd4d9641d4c10ef16636c8c4c4992ce356213 -->
