# YAŞAMIN İZİNDE — Dinleme/Izleme 4: Süreci Değerlendirebilme
...
- **Kullanılan etkinlikler:** `T3_ACT_16_DINLEME_DEGERLENDIRME`
- **Kullanılan formlar:** `FORM_T3_P216_GOZLEM_FORMU_05`, `FORM_T3_P224_OGRENME_GUNLUGU_06`
...
| Form | Kullanım |
|---|---|
| `FORM_T3_P216_GOZLEM_FORMU_05` | `USED` |
| `FORM_T3_P224_OGRENME_GUNLUGU_06` | `USED` |
...
## 1. Ders — Radyo Tiyatrosu Dinlemesini Değerlendirme: Gözlem ve Günlük Kanıtı
...
Öğrenci, “Süreci Değerlendirebilme” etkinliğinde dinleme/izleme sürecini ve metne ilişkin değerlendirmelerini ölçütlere dayalı biçimde yansıtır. Bu ders saatinin pedagojik odağı: radyo tiyatrosu dinleme sürecini doğrulanmış gözlem/günlük kanıtlarıyla değerlendirme; somut kanıt: Gözlem formu/öğrenme günlüğü destekli gerekçeli değerlendirme kaydı.

### Derse giriş

Metin Tahlili-3 (Anlama): Dinleme / İzleme — Radyo Tiyatrosu / Direnişin Ustaları — ders kitabı s.223 üzerinden bu saatin odağı görünür kılınır: Radyo tiyatrosu dinleme sürecini doğrulanmış gözlem/günlük kanıtlarıyla değerlendirme. Öğrenci önceki/başlangıç kanıtını kısa biçimde önüne alır ve bu saatin sonunda neyin değişmiş veya derinleşmiş olması gerektiğini kendi cümlesiyle belirtir.
...
4. Bu saate özgü kanıtı topla: Gözlem formu/öğrenme günlüğü destekli gerekçeli değerlendirme kaydı. Yalnız katılımı yeterli kanıt sayma; öğrencinin yaptığı bilişsel işlemi ürününde veya kaydında görünür kıl.

### Öğrencinin yapacakları

- Dinleme/izleme sürecini ve metne ilişkin değerlendirmelerini ölçütlere dayalı biçimde yansıtır.
- Radyo tiyatrosu dinleme sürecini doğrulanmış gözlem/günlük kanıtlarıyla değerlendirme.
- Kanıt olarak şunu üretir veya günceller: Gözlem formu/öğrenme günlüğü destekli gerekçeli değerlendirme kaydı.
- İlk kanıtında ikinci saatte sınayacağı, karşılaştıracağı, geliştireceği veya aktaracağı tek noktayı işaretler.

### Kaynak bağları

- **Etkinlikler:** `T3_ACT_16_DINLEME_DEGERLENDIRME`
- **Formlar:** Yok

### Ölçme / öğrenme kanıtı

Bu ders saatinin birincil ölçme kanıtı “Gözlem formu/öğrenme günlüğü destekli gerekçeli değerlendirme kaydı”dir. Değerlendirme, öğrencinin “Radyo tiyatrosu dinleme sürecini doğrulanmış gözlem/günlük kanıtlarıyla değerlendirme” işlemini görünür ve gerekçeli biçimde yapıp yapmadığına dayanır; kaynakta doğrulanmamış puan aralığı veya rubrik ölçütü eklenmez.

### Kapanış

Öğrenci “Gözlem formu/öğrenme günlüğü destekli gerekçeli değerlendirme kaydı” kanıtında ikinci derse taşıyacağı tek soruyu, varsayımı veya geliştirme noktasını işaretler.

### Materyaller

- Metin Tahlili-3 (Anlama): Dinleme / İzleme — Radyo Tiyatrosu / Direnişin Ustaları — ders kitabı s.223
- Öğrencinin bu ders saatinde oluşturduğu somut kanıt kaydı

## 2. Ders — Değerlendirmeden Sonraki Dinlemeye: Strateji Kararı
...
Öğrenci, “Süreci Değerlendirebilme” etkinliğinde dinleme/izleme sürecini ve metne ilişkin değerlendirmelerini ölçütlere dayalı biçimde yansıtır. Bu ders saatinin pedagojik odağı: değerlendirme sonucunu sonraki dinleme görevinde uygulanacak açık strateji kararına dönüştürme; somut kanıt: Somut dinleme/izleme transfer kararı.

### Derse giriş

Metin Tahlili-3 (Anlama): Dinleme / İzleme — Radyo Tiyatrosu / Direnişin Ustaları — ders kitabı s.223 üzerinden bu saatin odağı görünür kılınır: Değerlendirme sonucunu sonraki dinleme görevinde uygulanacak açık strateji kararına dönüştürme. Öğrenci önceki/başlangıç kanıtını kısa biçimde önüne alır ve bu saatin sonunda neyin değişmiş veya derinleşmiş olması gerektiğini kendi cümlesiyle belirtir.
...
- Dinleme/izleme sürecini ve metne ilişkin değerlendirmelerini ölçütlere dayalı biçimde yansıtır.
- Değerlendirme sonucunu sonraki dinleme görevinde uygulanacak açık strateji kararına dönüştürme.
...
- **Etkinlikler:** `T3_ACT_16_DINLEME_DEGERLENDIRME`
- **Formlar:** `FORM_T3_P216_GOZLEM_FORMU_05`, `FORM_T3_P224_OGRENME_GUNLUGU_06`

### Ölçme / öğrenme kanıtı

Bu ders saatinin birincil ölçme kanıtı “Somut dinleme/izleme transfer kararı”dir. Değerlendirme, öğrencinin “Değerlendirme sonucunu sonraki dinleme görevinde uygulanacak açık strateji kararına dönüştürme” işlemini görünür ve gerekçeli biçimde yapıp yapmadığına dayanır; kaynakta doğrulanmamış puan aralığı veya rubrik ölçütü eklenmez.
...
<!-- TYMM_JSON_SHA256:3bd998362d737efb1aa60e3ec908f1cc867a5b97215f83eef72eeff8c3d5f52a -->
