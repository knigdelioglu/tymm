...
8 saatlik dinleme/izleme bloğunun bu 2 saatlik bölümünde ders kitabındaki doğrulanmış etkinlikler kullanılarak TDE1.2 çıktısına yönelik somut öğrenci kanıtı üretilir. Saat içi akış pedagojik öneridir; resmî MEB alt-saat sıralaması olarak sunulmaz.
...
Öğrencinin dinlenen/izlenen metnin konu, tema, ileti, söz varlığı ve bağlamından anlam oluşturur. sürecinde TDE1.2 çıktısına yönelik gözlenebilir ve gerekçeli kanıt üretmesi.
...
2. Öğrenciden dinlenen/izlenen metnin konu, tema, ileti, söz varlığı ve bağlamından anlam oluşturur. sırasında kararını metin, dinleme/izleme, konuşma ya da yazma ürünündeki somut göstergelerle gerekçelendirmesini iste.
3. Kanıt olarak anlama sorularına cevaplar ve yapılandırılmış dinleme/izleme notları. topla; yalnız “katıldı/yaptı” türü genel gözlemi yeterli kabul etme.
...
Bu ders saatinin ana ölçme kanıtı: Anlama sorularına cevaplar ve yapılandırılmış dinleme/izleme notları.. Öğretmen geri bildirimi kanıtın doğruluğu, gerekçesi ve görevin gerektirdiği beceriye uygunluğu üzerinden verilir.

### Kapanış

Öğrenci “Bu derste anlama sorularına cevaplar ve yapılandırılmış dinleme/izleme notları. ile neyi gösterebildim; bir sonraki uygulamada hangi somut değişikliği yapacağım?” sorusuna kısa kanıt notuyla cevap verir.
...
<!-- TYMM_JSON_SHA256:80e408616537a3dc1cda5ee0b962935ff120b1d5a14e9e641d0ca20d7556e38f -->
