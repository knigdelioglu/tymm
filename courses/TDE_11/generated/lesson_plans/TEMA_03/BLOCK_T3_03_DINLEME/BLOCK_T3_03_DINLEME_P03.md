...
8 saatlik dinleme/izleme bloğunun bu 2 saatlik bölümünde ders kitabındaki doğrulanmış etkinlikler kullanılarak TDE1.3 çıktısına yönelik somut öğrenci kanıtı üretilir. Saat içi akış pedagojik öneridir; resmî MEB alt-saat sıralaması olarak sunulmaz.
...
Öğrencinin çok modlu metni yapı, tür, dil-anlatım, kişi/olay/ileti ve bağlam yönlerinden çözümler. sürecinde TDE1.3 çıktısına yönelik gözlenebilir ve gerekçeli kanıt üretmesi.
...
2. Öğrenciden çok modlu metni yapı, tür, dil-anlatım, kişi/olay/ileti ve bağlam yönlerinden çözümler. sırasında kararını metin, dinleme/izleme, konuşma ya da yazma ürünündeki somut göstergelerle gerekçelendirmesini iste.
3. Kanıt olarak tahlil cevapları, karşılaştırma/şema kayıtları ve gerekçeli çıkarımlar. topla; yalnız “katıldı/yaptı” türü genel gözlemi yeterli kabul etme.
...
Bu ders saatinin ana ölçme kanıtı: Tahlil cevapları, karşılaştırma/şema kayıtları ve gerekçeli çıkarımlar.. Öğretmen geri bildirimi kanıtın doğruluğu, gerekçesi ve görevin gerektirdiği beceriye uygunluğu üzerinden verilir.

### Kapanış

Öğrenci “Bu derste tahlil cevapları, karşılaştırma/şema kayıtları ve gerekçeli çıkarımlar. ile neyi gösterebildim; bir sonraki uygulamada hangi somut değişikliği yapacağım?” sorusuna kısa kanıt notuyla cevap verir.
...
<!-- TYMM_JSON_SHA256:a8dc5bd72a718444b53f3d396c573f21c0e153b770e6fb8641e1b14071111580 -->
