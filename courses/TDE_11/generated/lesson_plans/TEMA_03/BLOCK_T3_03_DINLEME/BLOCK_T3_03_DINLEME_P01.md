...
8 saatlik dinleme/izleme bloğunun bu 2 saatlik bölümünde ders kitabındaki doğrulanmış etkinlikler kullanılarak TDE1.1 çıktısına yönelik somut öğrenci kanıtı üretilir. Saat içi akış pedagojik öneridir; resmî MEB alt-saat sıralaması olarak sunulmaz.
...
Öğrencinin dinleme/izleme amacını ve stratejisini belirler, ön bilgilerini etkinleştirir ve tahminde bulunur. sürecinde TDE1.1 çıktısına yönelik gözlenebilir ve gerekçeli kanıt üretmesi.

### Derse giriş

“Dinleme / İzlemeyi Yönetebilme” görevinin amacı ve beklenen kanıt görünür hâle getirilir; öğrenci neyi göstereceğini kendi cümlesiyle ifade eder.

### Öğretmenin yapacakları

1. “Dinleme / İzlemeyi Yönetebilme” etkinliğinin yönergesini ders kitabındaki doğrulanmış kapsamla uygula; kaynakta olmayan ölçüt veya içerik ekleme.
2. Öğrenciden dinleme/izleme amacını ve stratejisini belirler, ön bilgilerini etkinleştirir ve tahminde bulunur. sırasında kararını metin, dinleme/izleme, konuşma ya da yazma ürünündeki somut göstergelerle gerekçelendirmesini iste.
3. Kanıt olarak amaç/strateji kaydı, tahmin ve hazırlık notları. topla; yalnız “katıldı/yaptı” türü genel gözlemi yeterli kabul etme.
...
Bu ders saatinin ana ölçme kanıtı: Amaç/strateji kaydı, tahmin ve hazırlık notları.. Öğretmen geri bildirimi kanıtın doğruluğu, gerekçesi ve görevin gerektirdiği beceriye uygunluğu üzerinden verilir.

### Kapanış

Öğrenci “Bu derste amaç/strateji kaydı, tahmin ve hazırlık notları. ile neyi gösterebildim; bir sonraki uygulamada hangi somut değişikliği yapacağım?” sorusuna kısa kanıt notuyla cevap verir.
...
<!-- TYMM_JSON_SHA256:beb264fb9b862d79493bf87bcbd3c11aeb950661f08710e85ed902e9f43125d1 -->
