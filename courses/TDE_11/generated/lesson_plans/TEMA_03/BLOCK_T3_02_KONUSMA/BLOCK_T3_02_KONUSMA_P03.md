# YAŞAMIN İZİNDE — Konuşma 3: Kural Uygulayabilme
...
## 1. Ders — Hayalî Mülakat I: İlk Performans ve Gözlem
...
Öğrenci, “Kural Uygulayabilme” etkinliğinde planladığı konuşmayı bağlama uygun dil, beden dili, ses, zaman ve mekân kullanımıyla gerçekleştirir. Bu ders saatinin pedagojik odağı: hayalî mülakatı bağlama uygun dil, beden dili, ses, zaman ve mekân kullanımıyla gerçekleştirme; somut kanıt: İlk canlı hayalî mülakat performansı ve gözlem kaydı.

### Derse giriş

Edebiyat Atölyesi-1 (Anlatma): Konuşma — Hayalî Mülakat — ders kitabı s.213 üzerinden bu saatin odağı görünür kılınır: Hayalî mülakatı bağlama uygun dil, beden dili, ses, zaman ve mekân kullanımıyla gerçekleştirme. Öğrenci önceki/başlangıç kanıtını kısa biçimde önüne alır ve bu saatin sonunda neyin değişmiş veya derinleşmiş olması gerektiğini kendi cümlesiyle belirtir.
...
4. Bu saate özgü kanıtı topla: İlk canlı hayalî mülakat performansı ve gözlem kaydı. Yalnız katılımı yeterli kanıt sayma; öğrencinin yaptığı bilişsel işlemi ürününde veya kaydında görünür kıl.

### Öğrencinin yapacakları

- Planladığı konuşmayı bağlama uygun dil, beden dili, ses, zaman ve mekân kullanımıyla gerçekleştirir.
- Hayalî mülakatı bağlama uygun dil, beden dili, ses, zaman ve mekân kullanımıyla gerçekleştirme.
- Kanıt olarak şunu üretir veya günceller: İlk canlı hayalî mülakat performansı ve gözlem kaydı.
...
Bu ders saatinin birincil ölçme kanıtı “İlk canlı hayalî mülakat performansı ve gözlem kaydı”dir. Değerlendirme, öğrencinin “Hayalî mülakatı bağlama uygun dil, beden dili, ses, zaman ve mekân kullanımıyla gerçekleştirme” işlemini görünür ve gerekçeli biçimde yapıp yapmadığına dayanır; kaynakta doğrulanmamış puan aralığı veya rubrik ölçütü eklenmez.

### Kapanış

Öğrenci “İlk canlı hayalî mülakat performansı ve gözlem kaydı” kanıtında ikinci derse taşıyacağı tek soruyu, varsayımı veya geliştirme noktasını işaretler.
...
## 2. Ders — Hayalî Mülakat II: Gözlemden Yeniden Performansa
...
Öğrenci, “Kural Uygulayabilme” etkinliğinde planladığı konuşmayı bağlama uygun dil, beden dili, ses, zaman ve mekân kullanımıyla gerçekleştirir. Bu ders saatinin pedagojik odağı: gözlem kanıtından seçilen hedefli değişikliği uygulayarak ikinci mülakat performansını gerçekleştirme; somut kanıt: Geliştirilmiş ikinci performans ve değişiklik açıklaması.

### Derse giriş

Edebiyat Atölyesi-1 (Anlatma): Konuşma — Hayalî Mülakat — ders kitabı s.213 üzerinden bu saatin odağı görünür kılınır: Gözlem kanıtından seçilen hedefli değişikliği uygulayarak ikinci mülakat performansını gerçekleştirme. Öğrenci önceki/başlangıç kanıtını kısa biçimde önüne alır ve bu saatin sonunda neyin değişmiş veya derinleşmiş olması gerektiğini kendi cümlesiyle belirtir.
...
- Planladığı konuşmayı bağlama uygun dil, beden dili, ses, zaman ve mekân kullanımıyla gerçekleştirir.
- Gözlem kanıtından seçilen hedefli değişikliği uygulayarak ikinci mülakat performansını gerçekleştirme.
...
Bu ders saatinin birincil ölçme kanıtı “Geliştirilmiş ikinci performans ve değişiklik açıklaması”dir. Değerlendirme, öğrencinin “Gözlem kanıtından seçilen hedefli değişikliği uygulayarak ikinci mülakat performansını gerçekleştirme” işlemini görünür ve gerekçeli biçimde yapıp yapmadığına dayanır; kaynakta doğrulanmamış puan aralığı veya rubrik ölçütü eklenmez.
...
- **Kullanılan etkinlikler:** `T3_ACT_11_KONUSMA_UYGULAMA_COZUMLEME`
- **Sonraki adım:** Aynı konuşma bloğunda kalan 4 saatte kullanılmamış veya derinleştirilecek doğrulanmış kitap etkinlikleriyle beceri kanıtını ilerlet.

---

<!-- TYMM_JSON_SHA256:f6135cae5868af79c5036d2cd87b1690a83a26af0bc43ee9965f7f8896259b59 -->
