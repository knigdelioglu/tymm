# HAYATIN AYNASI — Dinleme/Izleme 4: Süreci Değerlendirebilme
...
- **Kullanılan etkinlikler:** `T4_ACT_16_DINLEME_DEGERLENDIRME`
- **Kullanılan formlar:** `FORM_T4_P286_KONTROL_LISTESI_03`, `FORM_T4_P297_OGRENME_GUNLUGU_04`
...
| Form | Kullanım |
|---|---|
| `FORM_T4_P286_KONTROL_LISTESI_03` | `USED` |
| `FORM_T4_P297_OGRENME_GUNLUGU_04` | `USED` |
...
- **Etkinlikler:** `T4_ACT_16_DINLEME_DEGERLENDIRME`
- **Formlar:** Yok
...
- Metin Tahlili-3 (Anlama): Dinleme / İzleme — Anadolu İnsanı / Fedakârlık — ders kitabı s.297
...
- **Etkinlikler:** `T4_ACT_16_DINLEME_DEGERLENDIRME`
- **Formlar:** `FORM_T4_P286_KONTROL_LISTESI_03`, `FORM_T4_P297_OGRENME_GUNLUGU_04`
