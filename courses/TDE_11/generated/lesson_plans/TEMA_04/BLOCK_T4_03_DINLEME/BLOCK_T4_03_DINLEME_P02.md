# HAYATIN AYNASI — Dinleme/Izleme 2: Anlam Oluşturabilme
...
- **Kullanılan etkinlikler:** `T4_ACT_14_DINLEME_ICERIK_ANLAM`
...
## 1. Ders — Anadolu İnsanı / Fedakârlık’ta Anlam Kanıtlarını Toplama
...
Öğrenci, “Anlam Oluşturabilme” etkinliğinde dinlenen/izlenen metnin konu, tema, ileti, söz varlığı ve bağlamından anlam oluşturur. Bu ders saatinin pedagojik odağı: konu, tema, ileti, söz varlığı ve bağlama ilişkin işitsel/görsel kanıtları seçme; somut kanıt: Anlama cevapları ve yapılandırılmış dinleme/izleme notları.

### Derse giriş

Metin Tahlili-3 (Anlama): Dinleme / İzleme — Anadolu İnsanı / Fedakârlık — ders kitabı s.287 üzerinden bu saatin odağı görünür kılınır: Konu, tema, ileti, söz varlığı ve bağlama ilişkin işitsel/görsel kanıtları seçme. Öğrenci önceki/başlangıç kanıtını kısa biçimde önüne alır ve bu saatin sonunda neyin değişmiş veya derinleşmiş olması gerektiğini kendi cümlesiyle belirtir.
...
- Konu, tema, ileti, söz varlığı ve bağlama ilişkin işitsel/görsel kanıtları seçme.
...
- **Etkinlikler:** `T4_ACT_14_DINLEME_ICERIK_ANLAM`
- **Formlar:** Yok

### Ölçme / öğrenme kanıtı

Bu ders saatinin birincil ölçme kanıtı “Anlama cevapları ve yapılandırılmış dinleme/izleme notları”dir. Değerlendirme, öğrencinin “Konu, tema, ileti, söz varlığı ve bağlama ilişkin işitsel/görsel kanıtları seçme” işlemini görünür ve gerekçeli biçimde yapıp yapmadığına dayanır; kaynakta doğrulanmamış puan aralığı veya rubrik ölçütü eklenmez.
...
- Metin Tahlili-3 (Anlama): Dinleme / İzleme — Anadolu İnsanı / Fedakârlık — ders kitabı s.287
- Öğrencinin bu ders saatinde oluşturduğu somut kanıt kaydı

## 2. Ders — Konu, Tema ve İleti: Medya Kanıtından Yoruma
...
Öğrenci, “Anlam Oluşturabilme” etkinliğinde dinlenen/izlenen metnin konu, tema, ileti, söz varlığı ve bağlamından anlam oluşturur. Bu ders saatinin pedagojik odağı: seçilen medya kanıtlarının anlam ve iletiyle ilişkisini yorumlama; somut kanıt: Kanıt-yorum eşleştirmesi ve gerekçeli dinleme/izleme kaydı.

### Derse giriş

Metin Tahlili-3 (Anlama): Dinleme / İzleme — Anadolu İnsanı / Fedakârlık — ders kitabı s.287 üzerinden bu saatin odağı görünür kılınır: Seçilen medya kanıtlarının anlam ve iletiyle ilişkisini yorumlama. Öğrenci önceki/başlangıç kanıtını kısa biçimde önüne alır ve bu saatin sonunda neyin değişmiş veya derinleşmiş olması gerektiğini kendi cümlesiyle belirtir.
...
4. Bu saate özgü kanıtı topla: Kanıt-yorum eşleştirmesi ve gerekçeli dinleme/izleme kaydı. Yalnız katılımı yeterli kanıt sayma; öğrencinin yaptığı bilişsel işlemi ürününde veya kaydında görünür kıl.

### Öğrencinin yapacakları

- Dinlenen/izlenen metnin konu, tema, ileti, söz varlığı ve bağlamından anlam oluşturur.
- Seçilen medya kanıtlarının anlam ve iletiyle ilişkisini yorumlama.
- Kanıt olarak şunu üretir veya günceller: Kanıt-yorum eşleştirmesi ve gerekçeli dinleme/izleme kaydı.
...
Bu ders saatinin birincil ölçme kanıtı “Kanıt-yorum eşleştirmesi ve gerekçeli dinleme/izleme kaydı”dir. Değerlendirme, öğrencinin “Seçilen medya kanıtlarının anlam ve iletiyle ilişkisini yorumlama” işlemini görünür ve gerekçeli biçimde yapıp yapmadığına dayanır; kaynakta doğrulanmamış puan aralığı veya rubrik ölçütü eklenmez.
...
<!-- TYMM_JSON_SHA256:7631db29f813de555dfa69dfe9aede9888d53302ce95e2ca76a7511dcdf320a0 -->
