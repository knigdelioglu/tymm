# BİR DİYECEĞİM VAR! — Konuşma 1: Konuşmayı Yönetebilme
...
- **Kullanılan etkinlikler:** `T1_ACT_09_KONUSMA_YONETIM`
...
## 1. Ders — Drama İçin Konuşma Planı: Amaç, Hedef Kitle ve Roller
...
Öğrenci, “Konuşmayı Yönetebilme” etkinliğinde konuşmanın amacını, hedef kitlesini, yöntem/stratejisini, hazırlık ve uygulama koşullarını planlar. Bu ders saatinin pedagojik odağı: drama konuşmasının amacı, hedef kitlesi, stratejisi ve görev dağılımını planlama; somut kanıt: Konuşma/canlandırma planı ve görev kayıtları.

### Derse giriş

Edebiyat Atölyesi-1 (Anlatma): Konuşma — Sözlü İletişim Engellerini Konu Alan Bir Drama — ders kitabı s.53 üzerinden bu saatin odağı görünür kılınır: Drama konuşmasının amacı, hedef kitlesi, stratejisi ve görev dağılımını planlama. Öğrenci önceki/başlangıç kanıtını kısa biçimde önüne alır ve bu saatin sonunda neyin değişmiş veya derinleşmiş olması gerektiğini kendi cümlesiyle belirtir.
...
4. Bu saate özgü kanıtı topla: Konuşma/canlandırma planı ve görev kayıtları. Yalnız katılımı yeterli kanıt sayma; öğrencinin yaptığı bilişsel işlemi ürününde veya kaydında görünür kıl.

### Öğrencinin yapacakları

- Konuşmanın amacını, hedef kitlesini, yöntem/stratejisini, hazırlık ve uygulama koşullarını planlar.
- Drama konuşmasının amacı, hedef kitlesi, stratejisi ve görev dağılımını planlama.
- Kanıt olarak şunu üretir veya günceller: Konuşma/canlandırma planı ve görev kayıtları.
- İlk kanıtında ikinci saatte sınayacağı, karşılaştıracağı, geliştireceği veya aktaracağı tek noktayı işaretler.

### Kaynak bağları

- **Etkinlikler:** `T1_ACT_09_KONUSMA_YONETIM`
- **Formlar:** Yok

### Ölçme / öğrenme kanıtı

Bu ders saatinin birincil ölçme kanıtı “Konuşma/canlandırma planı ve görev kayıtları”dir. Değerlendirme, öğrencinin “Drama konuşmasının amacı, hedef kitlesi, stratejisi ve görev dağılımını planlama” işlemini görünür ve gerekçeli biçimde yapıp yapmadığına dayanır; kaynakta doğrulanmamış puan aralığı veya rubrik ölçütü eklenmez.

### Kapanış

Öğrenci “Konuşma/canlandırma planı ve görev kayıtları” kanıtında ikinci derse taşıyacağı tek soruyu, varsayımı veya geliştirme noktasını işaretler.

### Materyaller

- Edebiyat Atölyesi-1 (Anlatma): Konuşma — Sözlü İletişim Engellerini Konu Alan Bir Drama — ders kitabı s.53
- Öğrencinin bu ders saatinde oluşturduğu somut kanıt kaydı

## 2. Ders — Drama Planını Savunma: Strateji ve Uygulama Koşulları
...
Öğrenci, “Konuşmayı Yönetebilme” etkinliğinde konuşmanın amacını, hedef kitlesini, yöntem/stratejisini, hazırlık ve uygulama koşullarını planlar. Bu ders saatinin pedagojik odağı: plan tercihlerini iletişim amacı ve uygulama koşullarıyla gerekçelendirip savunma; somut kanıt: Gerekçelendirilmiş ve gerektiğinde revize edilmiş konuşma planı.

### Derse giriş

Edebiyat Atölyesi-1 (Anlatma): Konuşma — Sözlü İletişim Engellerini Konu Alan Bir Drama — ders kitabı s.53 üzerinden bu saatin odağı görünür kılınır: Plan tercihlerini iletişim amacı ve uygulama koşullarıyla gerekçelendirip savunma. Öğrenci önceki/başlangıç kanıtını kısa biçimde önüne alır ve bu saatin sonunda neyin değişmiş veya derinleşmiş olması gerektiğini kendi cümlesiyle belirtir.
...
4. Bu saate özgü kanıtı topla: Gerekçelendirilmiş ve gerektiğinde revize edilmiş konuşma planı. Yalnız katılımı yeterli kanıt sayma; öğrencinin yaptığı bilişsel işlemi ürününde veya kaydında görünür kıl.

### Öğrencinin yapacakları

- Konuşmanın amacını, hedef kitlesini, yöntem/stratejisini, hazırlık ve uygulama koşullarını planlar.
- Plan tercihlerini iletişim amacı ve uygulama koşullarıyla gerekçelendirip savunma.
- Kanıt olarak şunu üretir veya günceller: Gerekçelendirilmiş ve gerektiğinde revize edilmiş konuşma planı.
...
Bu ders saatinin birincil ölçme kanıtı “Gerekçelendirilmiş ve gerektiğinde revize edilmiş konuşma planı”dir. Değerlendirme, öğrencinin “Plan tercihlerini iletişim amacı ve uygulama koşullarıyla gerekçelendirip savunma” işlemini görünür ve gerekçeli biçimde yapıp yapmadığına dayanır; kaynakta doğrulanmamış puan aralığı veya rubrik ölçütü eklenmez.
...
- **Blokta kalan:** 8 saat
- **Kapsanan çıktılar:** `TDE3.1`
- **Kullanılan etkinlikler:** `T1_ACT_09_KONUSMA_YONETIM`
- **Sonraki adım:** Aynı konuşma bloğunda kalan 8 saatte kullanılmamış veya derinleştirilecek doğrulanmış kitap etkinlikleriyle beceri kanıtını ilerlet.

---

<!-- TYMM_JSON_SHA256:41a9c5ff4d41870cde0198c33cb9a64d6ac12e6ee36835d9de623eb401f42548 -->
