# BİR DİYECEĞİM VAR! — Okuma 8: Süreci Değerlendirebilme
...
- **Kullanılan etkinlikler:** `T1_ACT_08_OKUMA_DEGERLENDIRME`
- **Kullanılan formlar:** `FORM_T1_P035_OZ_DEGERLENDIRME_01`
...
| Form | Kullanım |
|---|---|
| `FORM_T1_P035_OZ_DEGERLENDIRME_01` | `USED` |
...
- **Etkinlikler:** `T1_ACT_08_OKUMA_DEGERLENDIRME`
- **Formlar:** `FORM_T1_P035_OZ_DEGERLENDIRME_01`
...
- Metin Tahlili-2 (Anlama): Okuma — Mektup (Âli’ye Mektuplar) / Dilekçe — ders kitabı s.46
